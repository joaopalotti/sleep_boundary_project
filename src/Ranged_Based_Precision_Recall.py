...
precision(ranges_real, ranges_pred, alpha= 0, bias_kind="flat", gamma_kind="reciprocal")

f1(ranges_real, ranges_pred, alpha= 0, bias_kind_r = "front", bias_kind_p = "flat", gamma_kind="reciprocal")
