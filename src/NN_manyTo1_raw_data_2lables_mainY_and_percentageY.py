...
#     X, Y, test_pids = extract_features("train_data.csv.gz", "test_data.csv.gz", use_gpu=True)
    X, Y, test_pids = create_xy("../data/processed/train_test_splits/10min_centered/train_raw_data.csv.gz", "../data/processed/train_test_splits/10min_centered/test_raw_data.csv.gz", use_gpu=True)
    save_data(datafolder, X, Y, test_pids)
