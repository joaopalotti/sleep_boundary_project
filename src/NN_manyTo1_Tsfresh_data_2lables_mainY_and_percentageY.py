...
#         self.net = LSTMLayer(input_size=48, break_point=48,
...
#     print("Data exists, we will only load it.")
...
#     X, Y, test_pids = extract_features("%s/train_raw_data.csv.gz" % datafolder,
#                                        "%s/test_raw_data.csv.gz" % datafolder,
#                                        use_gpu=True)
